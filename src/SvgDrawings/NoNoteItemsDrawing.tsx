  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20em" height="20em" viewBox="0 0 647.635 632.17">
        <g id="undraw_no_data_re_kwbl" transform="translate(-0.001 -0.004)">
            ...
            <path className={styles.Path_3} id="Path_3" data-name="Path 3" d="M398.863,261.734a9.016,9.016,0,0,1-8.611-6.367L377.371,213.3a9,9,0,0,1,5.971-11.24l175.939-53.864a9.009,9.009,0,0,1,11.241,5.971l12.88,42.072a9.01,9.01,0,0,1-5.971,11.241l-175.94,53.864a8.977,8.977,0,0,1-2.629.4Z" transform="translate(-276.182 -133.913)"/>
            <circle className={styles.Ellipse_1} id="Ellipse_1" data-name="Ellipse 1" cx="20" cy="20" r="20" transform="translate(170.154 4.955)"/>
            <circle id="Ellipse_2" data-name="Ellipse 2" cx="12.665" cy="12.665" r="12.665" transform="translate(177.489 12.29)" fill="#fff"/>
            <path id="Path_4" data-name="Path 4" d="M878.818,716.087h-338a8.51,8.51,0,0,1-8.5-8.5v-405a8.509,8.509,0,0,1,8.5-8.5h338a8.51,8.51,0,0,1,8.5,8.5v405A8.51,8.51,0,0,1,878.818,716.087Z" transform="translate(-276.182 -133.913)" fill="#f2f2f2"/>
            <path className={styles.Path_5} id="Path_5" data-name="Path 5" d="M723.318,274.087h-210.5a17.024,17.024,0,0,0-17,17v407.8l2-.61V291.087a15.018,15.018,0,0,1,15-15h211.12Zm183.5,0h-394a17.024,17.024,0,0,0-17,17v458a17.024,17.024,0,0,0,17,17h394a17.024,17.024,0,0,0,17-17v-458a17.024,17.024,0,0,0-17-17Zm15,475a15.018,15.018,0,0,1-15,15h-394a15.018,15.018,0,0,1-15-15v-458a15.018,15.018,0,0,1,15-15h394a15.018,15.018,0,0,1,15,15Z" transform="translate(-276.182 -133.913)" fill="#fff"/>
            <path className={styles.Path_6} id="Path_6" data-name="Path 6" d="M801.818,318.087h-184a9.01,9.01,0,0,1-9-9v-44a9.01,9.01,0,0,1,9-9h184a9.01,9.01,0,0,1,9,9v44a9.01,9.01,0,0,1-9,9Z" transform="translate(-276.182 -133.913)"/>
            <circle className={styles.Ellipse_3} id="Ellipse_3" data-name="Ellipse 3" cx="20" cy="20" r="20" transform="translate(413.636 85.174)"/>
            <circle id="Ellipse_4" data-name="Ellipse 4" cx="12.182" cy="12.182" r="12.182" transform="translate(421.454 92.992)" fill="#fff"/>
        </g>
    </svg>
  )
}
