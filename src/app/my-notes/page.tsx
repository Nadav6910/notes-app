...
export default function myNotes() {
  ...
  return (
    <main>
        <div>
            <Lottie className={styles.lottieAnimationNoNotes} animationData={animationData} />
            <div className={styles.addNotesLinkContainer}>
                <p>No notes added yet..</p>
                <MotionWrap
                    style={{borderRadius: "10px"}}
                    whileHover={{y: -4, boxShadow: "6px 7px 13px #2a2929"}}
                    transition={{ type: "spring", stiffness: 300, damping: 10, duration: 0.5, bounce: 1, mass: 1.3}}
                >
